            <!-- Start container-fluid -->
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    <h4 class="header-title mb-3">Sửa danh mục</h4>
                        ...
                        <div class="row"style="margin-top: 35px;" >
                            <div class="col-lg-6">
                                <form class="form-horizontal" style="width: 640px;" method="post" action="index?act=suadm&iddm='<?php echo $row['id']; ?>' "  enctype="multipart/form-data">
                                 <span style="text-align: left;">
                                    ...
                                    <div class="form-group row" style="margin-bottom: 30px;">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="example-email" name="name" class="form-control" value="<?php echo $row['name']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="margin-bottom: 30px;">
                                        ...
                                        <div class="col-md-10">
                                            <textarea  class="form-control" rows="5" id="mota" name="mota" >cc</textarea>
                                        </div>
                                    </div>
                                 </span>
                                 <span >
                                 ...
                                 <div style= "text-align: left;margin-left:110px;"> <button type="submit" class="btn text-center " style="background-color: green;color: white;width: 160px;" name="submit">Sửa danh mục</button></div>
                             </form>
                           </div>
                           <div class="col-lg-6">
                           
                            <span style="float: right;"><img style="height:260px;width:400px" id="previewImage" src="../../uploads/<?php echo $row['img'] ?>"></span>
